...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{nih24h.png}
  \caption{NIH24h distribution Plot and Mean}
  \label{fig:dataset-plot14}
\end{figure}
\pagebreak

\noindent Number of patients on wich the thrombectomy was performed. 
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{numThrombectomy.png}
  \caption{Number of Thrombectomy Procedures}
  \label{fig:dataset-plot15}
\end{figure}
